    ...
    <body>
        ...
        <div class="container">
            <c:if test="${user_id == null}">
                <% response.sendRedirect("http://localhost:8080/Inventory_Management_System/home");%>
            </c:if>
            ...
            <div class="col-md-12" style="text-align: center;">
                &copy; Mohammad Kamal Parvez
                || <a href="#" target="_blank">Github</a>  || <a href="#" target="_blank">Facebook</a>
            </div>
        ...
        <div class="floating_div" style="text-align: center;width: 120px; height: 190px; border: 1px solid #DDD; box-shadow: 0px 0px 5px #DDD; position: fixed; right: 0px; bottom: 0px;">
            <a href="#" target="_blank"><img src="<c:url value="/resources/img/kamal.jpg"></c:url>" width="100%"/></a>
            <br/>

           Mohammad Kamal Parvez <br/>
            <a href="#" target="_blank"><i class="fa fa-facebook"></i> Facebook</a> <br/>
            <a href="#" target="_blank"><i class="fa fa-youtube"></i> Github</a>
